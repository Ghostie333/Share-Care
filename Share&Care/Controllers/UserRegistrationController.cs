...
namespace Share_Care.Controllers
{
                                           ...
                                           IWalletService walletService) : ControllerBase
    {
        ...
        {
            _logger.LogInformation("Rozpocz�to rejestracj� u�ytkownika, email: {Email}", userRegistration.Email);
            ...
            try
            {
                ...
                {
                    _logger.LogWarning("Pr�ba rejestracji z istniej�cym emailem: {Email}", userRegistration.Email);
                ...
                _logger.LogInformation("Pomy�lnie utworzono u�ytkownika {UserId}, email: {Email}", 
                ...
                if (string.IsNullOrWhiteSpace(userForWallet.UserId))
                    return Problem("Nie uda�o si� utworzy� portfela dla u�ytkownika");
